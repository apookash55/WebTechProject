  ...
  <div class="container" style="margin-top: 80px;">
      ...
      <form id="MYFORM" class="" action="compileresult.php" method="post">
        <h1><label for="editor">Editor</label></h1>
      				...
      				<input id="SAVEBTN" type="submit" class="btn btn-danger mx-1" name="SAVE" value="SAVE" onclick="openForm()">
      				 ...
      				 <div class="jumbotron popup-form" id="myForm">
      				  <!--<form class= "form-group">-->
      				    ...
      				    <input class="form-control" type="text" placeholder="Untitled.java" name="filename" required>
      				        <br>
  			...
  			<textarea name="code" class="overflow-auto" id="editor" autofocus spellcheck="false" placeholder="Enter your code here..."><?php echo $foundCode;?>

  			</textarea>
  			<br>
  			<h1><label for="input">Input</label></h1>
  			<textarea name="codeInput" class="overflow-auto" id="input" spellcheck="false" placeholder="Enter your input case here(Leave this blank if not required)..." wrap="off"></textarea><br>
        <input class="compilerId" type="text" name="compilerId" value="2">
        <br>
